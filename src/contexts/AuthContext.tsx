...
import { getOrCreateDeviceId, getDeviceFingerprint, clearDeviceData } from '../lib/device';
import type { User, ComputedPermissions, LoginCredentials, ClientType } from '../types/auth';
