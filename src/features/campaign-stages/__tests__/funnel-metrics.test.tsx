...
describe('[Integration] Metrics dashboard', () => {
  it('loads metrics and renders chart and cards', () => {
    useCampaignFunnelMetrics.mockReturnValue({
      data: {
        campaignId: 'c1', totalLeads: 100, generatedAt: new Date().toISOString(), stages: [
          ...
          { stageId: 's2', stageName: 'Qualificação', categoria: 'qualificacao', cor: '#000', ordem: 1, leadCount: 40, percentageOfTotal: 40, conversionFromPrevious: 66.6, averageDurationHours: 24 },
        ]
      },
      isLoading: false,
      isError: false,
