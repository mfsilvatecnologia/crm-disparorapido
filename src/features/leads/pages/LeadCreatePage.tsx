...
import type { CreateLeadDTO } from '@/shared/services/schemas'
...
export default function LeadCreatePage() {
  ...
  const handleSubmit = async (values: LeadCreateFormValues) => {
    const organizationId = getEmpresaIdFromStorage() || user?.organizationId
    if (!organizationId) {
      toast({
        title: 'Organização não encontrada',
        description: 'Não foi possível ler a empresa do localStorage. Faça login novamente.',
        variant: 'destructive',
      })
      return
    }
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Cadastre um lead completo com todos os dados disponíveis.
            </p>
          </div>
